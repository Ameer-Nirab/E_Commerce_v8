            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="product-pagination text-right">
                        @if ($next)
                            <li><a href="{{ route('site.product', $next->slug) }}">Next
                                <i class="tf-ion-ios-arrow-left"></i></a>
                            </li>
                        @endif
                        @if ($prev)
                            <li><a href="{{ route('site.product', $prev->slug) }}">Preview
                                <i class="tf-ion-ios-arrow-right"></i></a>
                            </li>
                        @endif
                    </ol>
                </div>
